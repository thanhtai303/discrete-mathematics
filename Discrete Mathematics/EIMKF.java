...
public class EIMKF {
	...
	public static void main(String[] args) throws IOException {
		...
		Account[] accountList = relationshipGraph();
		countFriend(accountList);
	}

	public static Account[] relationshipGraph() {
		...
		for (Account a : accountList) {
			a.friendList.sort((f1, f2) -> (Integer.compare(f1.id, f2.id)));
		}
		return accountList;
	}

	public static void countFriend(Account[] accountList) {
	...
	static class Account {
		...
		public String toString() {
			StringBuilder sb = new StringBuilder();
			sb.append(this.id).append(" ").append(this.friendList.size()).append(" ");
